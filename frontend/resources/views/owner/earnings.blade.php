...
<body class="bg-gray-50">
    ...
    <div class="lg:pl-[280px] min-h-screen w-full">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 lg:py-10">
            ...
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="text-3xl md:text-4xl font-black text-gray-900">Earnings</h1>
                <p class="text-gray-500 mt-2 text-sm md:text-base">Track your revenue and bookings.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-10">
                ...
                <div class="bg-emerald-900 text-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-start justify-between">
                        <div class="flex-1 min-w-0">
                            <div class="text-2xl md:text-3xl font-black truncate">Rs. {{ number_format($total_earnings, 2) }}</div>
                            <div class="text-sm text-emerald-300 mt-2 font-medium">Total Earnings</div>
                        </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-start justify-between">
                        <div class="flex-1 min-w-0">
                            <div class="text-2xl md:text-3xl font-black text-gray-900">{{ $completed_count }}</div>
                            <div class="text-sm text-gray-500 mt-2 font-medium">Completed</div>
                        </div>
                        <span class="material-symbols-outlined text-emerald-600 text-3xl ml-3 flex-shrink-0">flag</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Bookings Section -->
            <div class="mb-6">
                <h2 class="text-xl md:text-2xl font-bold text-gray-900">All Bookings</h2>
            </div>
